...
```bash
curl -fsSL https://raw.githubusercontent.com/jiminu/selfishell/v0.2.1/install.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/jiminu/selfishell/v0.2.1/install.sh |
  bash -s -- --add-to-path
```
...
```bash
curl -fLO https://raw.githubusercontent.com/jiminu/selfishell/v0.2.1/install.sh
less install.sh
bash install.sh
```
