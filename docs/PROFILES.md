...
| `developer` | Minimal plus mise-managed Neovim 0.12.4, Node.js 24.18.0, Python 3.13.14, Temurin 17.0.19+10, kubectl 1.36.2, and kubectx 0.9.5; jq and build tooling remain OS packages |
