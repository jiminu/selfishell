...
Lua, Python, Bash, sh, JavaScript, TypeScript, JSON, YAML, and TOML LSP
support appears when a configured server attaches. Neovim's standard LSP
mappings remain available as well.
